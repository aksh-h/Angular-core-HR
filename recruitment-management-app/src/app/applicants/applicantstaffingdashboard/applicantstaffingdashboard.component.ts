...
@Component({
  selector: 'app-applicantstaffingdashboard',
  templateUrl: './applicantstaffingdashboard.component.html',
  styleUrls: ['./applicantstaffingdashboard.component.css']
})
export class ApplicantstaffingdashboardComponent implements OnInit {
  @ViewChild(MatAccordion) accordion: MatAccordion;
  @ViewChild(MatDrawer) drawer: MatDrawer;
  constructor(private dialogAnimation : NgDialogAnimationService,private activeRoute: ActivatedRoute, private router: Router, public Snackbar: SnackBarService, private service: ApplicantStaffingService, private _helpers: CommonHelpers, public dialog: MatDialog,) { }
  ...
  ShowAvailabe()
  {
   // this.showAvailableApplicants=false;
  //  var ele=document.getElementById('togg')
  //  var result=(ele.classList.contains('mat-checked'))
    debugger;
