...
export class EmployeeService {
  ...
  PostwithCustomController(Action: String, model: any,Controller: String) {   
    return this.httpclient.post( `${ENV.ApiURL}` + Controller + "/" + Action , model, { headers: this.httpHeaders })
  }
